 ...
 */
public class ImportFromArchiteezyWizard extends Wizard implements IImportWizard {
     ...
     * Default constructor.
     */
    public ImportFromArchiteezyWizard() {
    ...
    private void doImport(ConnectionProfile profile, RemoteModel remote, File targetFile, IProgressMonitor monitor)
        ...
        try {
            RepositoryService.INSTANCE.importModel(profile, remote, targetFile, monitor);
        } catch (Exception e) {
